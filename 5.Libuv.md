...
- When event occurs such as network packet arriving, the network hardware triggers an interrupt. The kernel identify which FD is ready now and adds it to ready list.
